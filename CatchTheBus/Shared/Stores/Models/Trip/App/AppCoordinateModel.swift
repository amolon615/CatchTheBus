...
extension AppCoordinateModel {
    static let testCoordinates1: [AppCoordinateModel] = [
    ...
    static let testCoordinates2: [AppCoordinateModel] = [
    ...
    static let testCoordinates3: [AppCoordinateModel] = [
    ...
    static let testCoordinates4: [AppCoordinateModel] = [
