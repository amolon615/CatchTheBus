...
struct AppCoordinateModel: Codable {
    let latitude: Double
    let longitude: Double
}

extension AppCoordinateModel {
    static var testCoordinates1: [AppCoordinateModel] = [
    ...
    static var testCoordinates2: [AppCoordinateModel] = [
    ...
    static var testCoordinates3: [AppCoordinateModel] = [
    ...
    static var testCoordinates4: [AppCoordinateModel] = [
